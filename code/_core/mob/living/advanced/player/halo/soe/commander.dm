...
/mob/living/advanced/player/antagonist/halo/soe/commander/setup_iff()
...
/mob/living/advanced/player/antagonist/halo/soe/commander/setup_name()
	. = ..()
	name = "Commander [real_name]"
	return TRUE


/mob/living/advanced/player/antagonist/halo/soe/commander/species_initialize(var/set_default=FALSE)
	. = ..()
