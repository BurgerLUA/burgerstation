...
/mob/living/advanced/player/antagonist/syndicate/Finalize()
	...
	to_chat(span("danger","<h1>An explosive implant was implanted in your body that triggers when you leave the Area of Operations. Avoid getting captured if you can.</h1>"))
