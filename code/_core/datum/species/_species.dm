/species/
	...
	var/list/emote_sounds_male_meme = list(
		...
		"deathgasp" = list('sound/voice/human/human_male_deathgasp_special_1.ogg','sound/voice/human/human_male_deathgasp_special_2.ogg','sound/voice/human/human_male_deathgasp_special_3.ogg'),
