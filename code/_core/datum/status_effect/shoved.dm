...
/status_effect/shoved/can_add_status_effect(atom/attacker,mob/living/victim)
...
/status_effect/shoved/on_effect_added(mob/living/owner,atom/source,magnitude,duration,stealthy)
