...
/reagent_recipe/explosion_water_potassium/on_react(var/mob/caller,var/reagent_container/container,var/magnitude)
	...
	container.owner.shoot_projectile(caller,get_step(explosion_location,pick(DIRECTIONS_ALL)),null,null,/obj/projectile/bullet/firearm/shotgun_pellet,/damagetype/ranged/shrapnel,16,16,4,TILE_SIZE*0.25,shrapnel_amount)
