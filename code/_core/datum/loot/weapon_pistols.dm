...
/loot/weapon/pistol/high_power
	...
	loot_table = list(
		/obj/item/weapon/ranged/bullet/magazine/pistol/high_power = 1,
...
/loot/weapon/pistol/laton
	...
	loot_table = list(
		/obj/item/weapon/ranged/bullet/magazine/pistol/laton = 1,
...
/loot/weapon/pistol/military
	...
	loot_table = list(
		/obj/item/weapon/ranged/bullet/magazine/pistol/military = 1,
		/obj/item/magazine/pistol_9mm = 4
	)
	loot_count = 4
	chance_none = 25
...
/loot/weapon/pistol/military/nanotrasen
	...
	loot_table = list(
		/obj/item/weapon/ranged/bullet/magazine/pistol/military/nanotrasen = 1,
		/obj/item/magazine/pistol_9mm = 4
	)
	loot_count = 4
	chance_none = 25
...
/loot/weapon/pistol/overseer
	...
	loot_table = list(
		/obj/item/weapon/ranged/bullet/magazine/pistol/overseer = 1,
		/obj/item/magazine/pistol_12mm = 4
	)
	loot_count = 4
	chance_none = 25
...
/loot/weapon/pistol/tactical
	...
	loot_table = list(
		/obj/item/weapon/ranged/bullet/magazine/pistol/tactical = 1,
...
/loot/weapon/pistol/tranq
	...
	loot_table = list(
		/obj/item/weapon/ranged/bullet/magazine/pistol/tranq = 1,
		/obj/item/magazine/pistol_tranq_11m = 4
	)
	loot_count = 4
	chance_none = 25
