/class/npc/robust
	...
	skills = list(
		...
		SKILL_MEDICINE = 100,
		SKILL_MAGIC_OFFENSIVE = 100,
		SKILL_MAGIC_SUPPORT = 100,
		SKILL_MAGIC_DEFENSIVE = 100,
		SKILL_MAGIC_REALITY = 100,
		SKILL_MAGIC_CHAOS = 100,
