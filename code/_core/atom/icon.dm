...
/atom/proc/add_overlay(datum/desired_overlay)
...
/atom/proc/add_underlay(datum/desired_underlay)
...
/atom/movable/proc/add_vis_content(atom/movable/desired_vis_content)
...
/atom/movable/proc/remove_vis_content(atom/movable/desired_vis_content)
