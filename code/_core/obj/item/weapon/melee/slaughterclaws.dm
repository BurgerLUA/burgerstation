...
/obj/item/weapon/melee/slaughterclaws/click_on_object(var/mob/activator,var/atom/object,location,control,params) //All blood costs are made with a level 50 VIT char in mind.
