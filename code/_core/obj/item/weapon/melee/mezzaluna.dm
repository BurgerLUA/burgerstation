/obj/item/weapon/melee/mezzaluna
	...
	desc_extended = "A massive razor blade-like sword, wielded from horizontal handles mounted on either sides of the blade. Devestating when used with chopping attacks, though nigh useless for any other swing."
