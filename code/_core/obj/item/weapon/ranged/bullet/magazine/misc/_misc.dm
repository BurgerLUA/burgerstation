...
/obj/item/weapon/ranged/bullet/magazine/misc/sentry/handle_empty(var/mob/activator)
	next_shoot_time = max(next_shoot_time,world.time + 20)
	return ..()

/obj/item/weapon/ranged/bullet/magazine/misc/sentry/handle_ammo(var/mob/activator)
...
/obj/item/weapon/ranged/bullet/magazine/misc/sentry/can_owner_shoot(var/mob/activator,var/atom/object,location,params)
