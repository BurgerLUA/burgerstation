...
/obj/item/weapon/ranged/bullet/magazine/rifle/assault/mod
	name = "\improper 7.62mm MOABR2"
	desc = "Space age technology calls for space age guns. This should easily rip someone a new hole."
	desc_extended = "A .308 chambered mother-of-all-battle-rifles (MOABR) developed by the Solarian research team for space battles. This version features a significantly faster firerate and lighter build, and uses NT standard 7.62mm mags instead."
...
/obj/item/weapon/ranged/bullet/magazine/rifle/assault/mod/get_static_spread()
	return 0.02

/obj/item/weapon/ranged/bullet/magazine/rifle/assault/mod/get_skill_spread(var/mob/living/L)
