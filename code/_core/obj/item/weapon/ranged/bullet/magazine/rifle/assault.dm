/obj/item/weapon/ranged/bullet/magazine/rifle/assault
	name = "\improper .308 AR-NT"
	desc = "Space age technology calls for space age guns. This should easily rip someone a new hole."
	desc_extended = "A .308 chambered mother-of-all-assault-rifles (MOAAR) developed by the NanoTrasen research team to rival the syndicate .308 marksman rifle, but without the slow shooting speed. Nicknamed the \"Arn't\" for what the enemy will be when an entire magazine is fired into them."
