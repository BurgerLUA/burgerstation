...
/obj/item/weapon/ranged/bullet/magazine/rifle/burst/get_static_spread() //Base spread
	if(!wielded)
		return 0.15
	return 0

/obj/item/weapon/ranged/bullet/magazine/rifle/burst/get_skill_spread(var/mob/living/L) //Base spread
	if(!heat_current)
		return 0
