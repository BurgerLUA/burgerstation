...
/obj/item/weapon/ranged/bullet/magazine/rifle/m13/get_skill_spread(mob/living/L)
	return max(0,0.01 - (0.02 * L.get_skill_power(SKILL_RANGED)))

/obj/item/weapon/ranged/bullet/magazine/rifle/m13/load_new_bullet_from_magazine(mob/caller)
	. = ..()
...
/obj/item/weapon/ranged/bullet/magazine/rifle/m13/clicked_on_by_object(mob/caller as mob,atom/object,location,control,params) //The src was clicked on by the object
...
/obj/item/weapon/ranged/bullet/magazine/rifle/m13/accept_bullet(mob/caller as mob,obj/item/bullet_cartridge/B,silent=FALSE)
