/obj/item/weapon/ranged/bullet/revolver/deckhard
	...
	desc_extended = "While Semiautos have become standard issue for Space Police, diehard Sergeants still tout the higher reliability of a revolver as a reason to carry these."
