...
/obj/item/weapon/ranged/bullet/revolver/fiendish/click_self(var/mob/activator,location,control,params)

	INTERACT_CHECK
	INTERACT_DELAY(1)

	rotate_cylinder(-1)
	activator?.to_chat(span("notice","You rotate a bone chamber backwards."))
	return TRUE