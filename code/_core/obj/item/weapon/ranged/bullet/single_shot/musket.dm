/obj/item/weapon/ranged/bullet/single_shot/musket
	...
	icon = 'icons/obj/item/weapons/ranged/single_shot/musket.dmi'
	...
	bullet_time = 0
	timed_bullet = list(
		/obj/item/bullet_cartridge/flintlock = 18,
		/obj/item/bullet_cartridge/flintlock/premium = 12
	)
...
/obj/item/weapon/ranged/bullet/single_shot/musket/get_static_spread()
	return 0.005 //Smoothbore

/obj/item/weapon/ranged/bullet/single_shot/flintlock/get_skill_spread(var/mob/living/L)
	return max(0,0.012 - (0.012 * L.get_skill_power(SKILL_RANGED)))


/obj/item/weapon/ranged/bullet/single_shot/musket/Generate()
