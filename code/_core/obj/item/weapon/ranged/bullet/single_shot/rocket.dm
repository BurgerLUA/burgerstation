...
/obj/item/weapon/ranged/bullet/single_shot/rocket/get_base_spread()
	return 0.02

/obj/item/weapon/ranged/bullet/single_shot/rocket/get_static_spread()
	return 0.005

/obj/item/weapon/ranged/bullet/single_shot/rocket/get_skill_spread(var/mob/living/L)
	return max(0,0.03 - (0.12 * L.get_skill_power(SKILL_RANGED)))

/obj/item/weapon/ranged/bullet/single_shot/rocket/use_condition(var/amount_to_use=1)
	adjust_quality(-10)
	return TRUE