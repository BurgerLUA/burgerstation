...
/obj/item/weapon/ranged/energy/abductor/get_skill_spread(mob/living/L)
	return max(0,0.05 - (0.02 * L.get_skill_power(SKILL_RANGED)))

/obj/item/weapon/ranged/energy/abductor/clicked_on_by_object(mob/caller,atom/object,location,control,params)
