/obj/item/weapon/ranged/spellgem/fractal
	...
	desc_extended = "A magical gem filled with pure arcane energy that gives the user the ability to cast spells. Can be augmented onto wands. This one shoots a firebrand that homes and pierces targets."
	icon_state = "damage"
