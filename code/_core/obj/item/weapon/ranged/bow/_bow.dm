...
/obj/item/weapon/ranged/bow/get_damage_per_hit(armor_to_use)
	...
	var/DPH = D.get_damage_per_hit(armor_to_use) * max(1, src.amount_max / 2) * ((stage_max / 100) + 0.25) / 2 //average shoot stack and average damage modifier used in calculations
