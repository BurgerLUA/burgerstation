...
/obj/item/bullet_cartridge/arrow/spend_bullet(mob/caller,bonus_misfire_chance=0)
...
/obj/item/bullet_cartridge/arrow/hardlight/spend_bullet(mob/caller,bonus_misfire_chance=0)
	return src
