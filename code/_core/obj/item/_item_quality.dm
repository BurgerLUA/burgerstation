...
/obj/item/proc/get_damage_icon_number(desired_quality = quality)
	if(quality == -1)
		return 0
	return FLOOR(clamp( (100 - quality) / (100/5),0,5 ),1)

/obj/item/proc/adjust_quality(quality_to_add=0)
...
/obj/item/proc/set_quality_max(desired_quality_max=100)
...
/obj/item/proc/update_quality_overlay(desired_damage_num = get_damage_icon_number())
