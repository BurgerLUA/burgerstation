...
/obj/item/clothing/glasses/thermal/rev
	...
	desc_extended = " Slav-Safe's in-built thermal imagery monocle, fitted with an additional medical and security HUDs. Theoretically shouldn't be detachable in any way possible."
