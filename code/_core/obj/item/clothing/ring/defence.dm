/obj/item/clothing/ring/iron/minor_defense
...
/obj/item/clothing/ring/gold/major_defense
	name = "Major Ring of Defense"
	desc = "A shiny circular ring. This one majorly increases your defence to basic attacks."
	armor = /armor/ring/major_defense
