...
/obj/item/fertilizer/save_item_data(var/save_inventory = TRUE,var/died=FALSE)
	. = ..()
	SAVEVAR("uses_left")

/obj/item/fertilizer/load_item_data_pre(var/mob/living/advanced/player/P,var/list/object_data)
	. = ..()
	LOADVAR("uses_left")
