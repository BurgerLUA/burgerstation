...
/obj/item/hope/save_item_data(var/mob/living/advanced/player/P,var/save_inventory = TRUE,var/died=FALSE)
	. = ..()
	SAVEVAR("next_resurrect")

/obj/item/hope/load_item_data_pre(var/mob/living/advanced/player/P,var/list/object_data)
	. = ..()
