...
/proc/play_the_fucking_game(var/mob/living/advanced/A)
	...
	if(!ENABLE_LORE)
		...
		A.show_hud(TRUE,FLAGS_HUD_MOB,FLAGS_HUD_SPECIAL,SECONDS_TO_DECISECONDS(3))
		return TRUE

	spawn(0)
		A.show_hud(FALSE,FLAGS_HUD_ALL,FLAGS_HUD_SPECIAL|FLAGS_HUD_WIDGET,SECONDS_TO_DECISECONDS(1))
