...
/obj/structure/interactive/bed/sleeper/medical/close(mob/caller)
	if(!buckled)
...
/obj/structure/interactive/bed/sleeper/medical/on_open(mob/caller)
...
/obj/structure/interactive/bed/sleeper/medical/on_close(mob/caller)
