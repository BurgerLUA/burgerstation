...
/obj/structure/interactive/ore_deposit/proc/create_ore(var/atom/activator,var/atom/drop_location,var/ore_to_create = 1)
...
/obj/structure/interactive/ore_deposit/floor/create_ore(var/atom/activator,var/atom/drop_location,var/ore_to_create = 1)
	. = ..()
	if(.)
		update_alpha()
