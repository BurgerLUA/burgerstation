...
/obj/hud/button/chargen/change_beardstyle/clicked_on_by_object(mob/caller,atom/object,location,control,params)
...
/obj/hud/button/chargen/beardstyle/clicked_on_by_object(mob/caller,atom/object,location,control,params)
	. = ..()
	if(. && is_advanced(caller))
		var/mob/living/advanced/A = caller
		A.handle_beardstyle_chargen(hair_num)
...
/obj/hud/button/chargen/beardstyle/main/clicked_on_by_object(mob/caller,atom/object,location,control,params)
