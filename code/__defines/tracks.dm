...
#define TRACKS_LOBBY list(/track/slow_fall,/track/boat,/track/two_thirty_six)
...
//unused boss: /track/nervous_journey, /track/night, /track/progression_mk4, /track/chords