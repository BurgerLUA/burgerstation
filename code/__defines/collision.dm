...
#define FLAG_COLLISION_WATER FLAG_COLLISION_WALKING | FLAG_COLLISION_SWIMMING | FLAG_COLLISION_CRAWLING
...
#define FLAG_COLLISION_BULLET_SPECIFIC 0x8 //You will always hit this if you specifically click on it.
