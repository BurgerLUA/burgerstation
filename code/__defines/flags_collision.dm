...
#define FLAG_COLLISION_BULLET 0x10
#define FLAG_COLLISION_ITEM 0x20

#define FLAG_COLLISION_REAL FLAG_COLLISION_WALKING | FLAG_COLLISION_FLYING | FLAG_COLLISION_SWIMMING | FLAG_COLLISION_ITEM
