...
#define TRACKS_LOBBY list(/track/second_rise,/track/as_themselves,/track/footsteps,/track/trailer,/track/grove)
...
//unused boss: /track/nervous_journey, /track/night, /track/progression_mk4, /track/chords, /track/industrial_beat, /track/from_evil, /track/dead
