...
#define LAYER_MOB_CLOTHING_HELMET      LAYER_MOB + 0.51
#define LAYER_MOB_CLOTHING_COAT        LAYER_MOB + 0.52
...
#define LAYER_MOB_INJURY_HANDS         LAYER_MOB + 0.61
#define LAYER_MOB_CLOTHING_HARDSUIT    LAYER_MOB + 0.62
...
#define LAYER_MOB_CLOTHING_BACK        LAYER_MOB + 0.71
