...
#define LAYER_MOB_HAIR_HEAD            LAYER_MOB_CLOTHING + 0.12
#define LAYER_MOB_CLOTHING_MASK        LAYER_MOB_CLOTHING + 0.13
#define LAYER_MOB_CLOTHING_HELMET      LAYER_MOB_CLOTHING + 0.14
#define LAYER_MOB_CLOTHING_NECK_OVER   LAYER_MOB_CLOTHING + 0.15
