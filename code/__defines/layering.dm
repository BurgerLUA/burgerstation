...
#define LAYER_MOB_HANDS                LAYER_MOB_CLOTHING + 0.15
#define LAYER_MOB_CLOTHING_GLOVES      LAYER_MOB_CLOTHING + 0.16
...
#define LAYER_MOB_CLOTHING_BACK        LAYER_MOB_CLOTHING + 0.20 //Backpacks
