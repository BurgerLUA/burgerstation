...
#define BLUEBERRY_SUPRISE list("#326393","#0E4187","#8BA4BC","#EAEAEA","#EAEAEA","#BE3333","#F4B25A")
#define LEATHER_CAR list("#C8954A","#916024","#92702F","#D6D6D6","#222222","#BE3333","#F4B25A")
#define NANOTRASEN_LOYALIST list("#0F4066","#0E3A5D","#607D94","#D6D6D6","#222222","#BE3333","#F4B25A")
#define MUTED_BLUE list("#5C636F","#384662","#1C2840","#DDDDDD","#36393F","#BE3333","#F4B25A")
