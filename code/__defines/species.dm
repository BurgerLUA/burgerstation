...
#define REPTILE_ARMOR list(BLADE=10,BLUNT=10,PIERCE=10,LASER=-10*3,ARCANE=AP_SWORD,HEAT=AP_SWORD,COLD=-AP_SWORD*3,BIO=AP_SWORD,HOLY=-AP_SWORD,DARK=AP_SWORD,ION=INFINITY)
#define CYBORG_ARMOR list(BLADE=10,BLUNT=-10*2,PIERCE=10,ARCANE=-AP_GREATSWORD,BIO=INFINITY,RAD=INFINITY,COLD=AP_SWORD,HEAT=-AP_SWORD,HOLY=INFINITY,DARK=INFINITY,PAIN=INFINITY,FATIGUE=INFINITY)
