...
#define SS_ORDER_AREAS 22
#define SS_ORDER_OBJS 23

#define SS_ORDER_POWER 30
#define SS_ORDER_SUNLIGHT 31
#define SS_ORDER_GENERATION 32
#define SS_ORDER_IMPORTANT 33
